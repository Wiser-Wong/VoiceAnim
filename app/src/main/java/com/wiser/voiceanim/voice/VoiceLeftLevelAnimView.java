...
public class VoiceLeftLevelAnimView extends View {
	...
	public VoiceLeftLevelAnimView(Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
	...
	private void onDrawAngel(Canvas canvas) {
		RectF oval = new RectF(waveRadius / 4, 0, waveRadius / 4 + 2 * waveRadius, 2 * waveRadius);
